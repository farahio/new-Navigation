      ...
      <View style={styles.container}>
        <View style={styles.header}>
          <View>
            ...
            <Image
              source={require("../asecct/book1.png")}
              style={styles.book}
            />
          </View>
          <View style={{ marginHorizontal: 15, marginBottom: 40 }}>
            ...
            >
              ...
              {/* <Image source={require("../asecct/book3.png")} /> */}
            </View>
        ...
        <View style={styles.main}>
          ...
          <View style={styles.mainBox}>
            ...
            <View style={{flexDirection:'row'}}>
              <Image source={require('../asecct/book4.png')}
        ...
        <View style={styles.footer}>
          ...
          renderItem={({ item }) => (
                  ...
                  <View style={styles.box}>
                    <Image source={{uri: item.volumeInfo.imageLinks.thumbnail}} style={styles.flatImage} />
...
export default  connect(mapStateToProps,{fetchProducts})(Book);